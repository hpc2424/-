...
void printHealthData(const HealthData* health_data) {
    ...
    for (i = 0; i < health_data->exercise_count; i++) {
        printf("Exercise: %s, Calories buned : %d kcal", health_data->exercises[i].exercise_name, health_data->exercises[i].calories_burned_per_minute);
    }
    ...
    if ((health_data->total_calories_intake - health_data->total_calories_burned) > 0)
        printf("Please exercise for your health!\n");
    else if ((health_data->total_calories_intake - health_data->total_calories_burned) < 0)
        printf("Your total intake for today has not reached your goal, remember to eat more!\n");
    else
        printf("perfect.\n");
